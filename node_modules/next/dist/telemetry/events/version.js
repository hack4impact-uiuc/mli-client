...
if(typeof "9.1.0"!=='string'){return Promise.resolve();}return(0,_storage.record)({eventName:EVENT_VERSION,payload:{nextVersion:"9.1.0",nodeVersion:process.version,cliCommand:event.cliCommand}});}